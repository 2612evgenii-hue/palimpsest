...
> **Граница применения.** F1 допустим только в разрешённом неоцениваемом
> контексте. Для диссертаций, дипломов, заданий и иных оцениваемых студенческих
> работ оптимизация текста под AI-детекторы отключена. Используйте F2/F3/F4
> для проверки структуры, фактов, источников, атрибуции и минимальной
> корректуры; см.
